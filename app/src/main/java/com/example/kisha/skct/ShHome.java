...
public class ShHome extends AppCompatActivity
{
    int flag = 0;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_sh_home);

        final int[] resource = new int[]{R.drawable.sa, R.drawable.sb, R.drawable.sc};

        imageView1 = (ImageView) findViewById(R.id.imageView45);
        imageView2 = (ImageView) findViewById(R.id.imageView46);
